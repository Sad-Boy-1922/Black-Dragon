...
logo = '\x1b[1;97m\n\x1b[1;93mTools :   \x1b[1;96mBlack Dragon-Cracker\x1b[1;97m\n\x1b[1;93mCreator :Sad-Boy 1922\x1b[1;97m\x1b[1;96m\x1b[1;97m \x1b[1;97m\n\x1b[1;93mTeam :  \x1b[1;91mBlack Coder Crush,Silent Ghost\n'
...
print '\x1b[1;96m  \ Crack Facebook\  \  /    '
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtube.com/sadboy1922')
                time.sleep(2)
                menu()
...
def pilih():
    zedd = raw_input('\x1b[1;96mroot@Sad-Boy1922 ')
    if zedd == '':
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.youtube.com/sadboy1922')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
