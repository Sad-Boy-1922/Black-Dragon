#Tools Untuk mencari admin page 
#Please Janagn Recode Bgsad
#Coded with Python
#english languange 
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf']
    ...
    try:
        site = raw_input ("Website untuk di scan?: ")
    ...
    print "Enter site source code/masukan Source code Web:"
    print "1 PHP"
    print "2 ASP"
    print "3 CFM"
    print "4 JS"
    ...
    print "\nPress 1 dan enter untuk memilih PHP\n "
    code=input("> ")
